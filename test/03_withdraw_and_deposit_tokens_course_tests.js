...
//           web3.eth.getTransaction(txHash.receipt.transactionHash).gasPrice; //here we have a problem
...
//         );
//         assert.isAtLeast(
//           parseFloat(balanceBeforeTransaction) -
//             parseFloat(balanceAfterDeposit),
//           parseFloat(web3.utils.toWei("1", "ether")),
...
//       })
//       .then(function(balanceToken) {
//         balanceTokenInTokenBeforeWithdrawal = balanceToken;
...
//       })
//       .then(function(balanceToken) {
//         balanceTokenInTokenAfterWithdrawal = balanceToken;
//         assert.equal(
